...
int main()
{
    ...
    for(auto country : tours.countries) {
        std::string cname = country.name;   
        // loop through the countries
        for(auto city : country.cities) {      // loop through the cities for each country
            std::cout   << std::setw(20) << std::left   << cname;
