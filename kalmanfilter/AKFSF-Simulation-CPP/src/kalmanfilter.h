...
{
    public:
        virtual VehicleState getVehicleState();
        virtual Matrix2d getVehicleStatePositionCovariance();

        virtual void predictionStep(double dt);
        virtual void predictionStep(GyroMeasurement gyro, double dt);
        virtual void handleLidarMeasurements(const std::vector<LidarMeasurement>& meas, const BeaconMap& map);
        virtual void handleLidarMeasurement(LidarMeasurement meas, const BeaconMap& map);
        virtual void handleGPSMeasurement(GPSMeasurement meas);
};

class LineraKalmanFilter : public KalmanFilter
{
        public:
        LineraKalmanFilter();
        virtual VehicleState getVehicleState();
