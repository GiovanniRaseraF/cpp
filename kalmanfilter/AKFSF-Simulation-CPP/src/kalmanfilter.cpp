...
LineraKalmanFilter::LineraKalmanFilter(){}
LineraKalmanFilter::~LineraKalmanFilter(){}

void LineraKalmanFilter::predictionStep(double dt)
{
...
void LineraKalmanFilter::handleGPSMeasurement(GPSMeasurement meas)
{
    if(isInitialised())
    {
        VectorXd state = getState();
...
Matrix2d LineraKalmanFilter::getVehicleStatePositionCovariance()
{
...
VehicleState LineraKalmanFilter::getVehicleState()
{
    if (isInitialised())
    {
...
void LineraKalmanFilter::predictionStep(GyroMeasurement gyro, double dt){predictionStep(dt);}
void LineraKalmanFilter::handleLidarMeasurements(const std::vector<LidarMeasurement>& dataset, const BeaconMap& map){}
void LineraKalmanFilter::handleLidarMeasurement(LidarMeasurement meas, const BeaconMap& map){}
